<template>
    <div class="w-full">
        ...
        <div class="w-full justify-center md:justify-normal flex flex-row flex-wrap cursor-pointer gap-8 pb-16">
            <!-- Articles -->
            <div v-for="(post, i) in posts" :key="post.id" class="w-11/12 md:w-72 border border-[#27272a] rounded-md">
                <div class="w-full h-48 flex justify-center items-center bg-purple-700 rounded-t-md">
                    <img :src="post.imagemCapa || 'https://blog.marcusoliveiradev.com.br/wp-content/uploads/2022/11/pexels-luis-gomes-546819-1.jpg'"
                        alt="Capa do post" class="w-full h-full object-cover" />
                </div>
